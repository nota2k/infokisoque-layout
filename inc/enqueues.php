...
$vite_assets_loader->enqueue_style( 'theme-css-bundle', 'src/scss/theme.scss');
$vite_assets_loader->enqueue_editor_style( 'block-editor-bundle', 'src/scss/block-editor.scss' );
